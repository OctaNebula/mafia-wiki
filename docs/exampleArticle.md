...
<div class="flex-container" style="display: flex; align-items: flex-start;">
    <div style="flex: 1;">
        This is the <b>introduction</b> paragraph on the wiki page. When writing this, don't add too much text as it might break the site for mobile users. Keep everything within 3 sentences.
    </div>
